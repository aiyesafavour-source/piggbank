  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK } = await import("./dist-WMSVSL46.js");
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createCoinbaseWalletSDK } = await import("./dist-DGO6SWUG.js");
    ...
    return {
      ...
      async getProvider() {
        porto_promise ?? (porto_promise = (async () => {
          const { Porto } = await import("./_dist-JBZQYRI6.js");
          return Porto.create({
            ...parameters,
    ...
    async getProvider() {
      ...
      if (!provider_) {
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await import("./dist-IXL7B3FF.js");
    ...
    async getProvider({ chainId } = {}) {
      ...
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-5ND6LK2G.js");
